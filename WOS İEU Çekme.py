...
QUERY_PARAMS = {
    "db": "WOS",
    "q": 'OG="Izmir Ekonomi Universitesi" AND FPY=1900-2030',
    "limit": 50
}
...
df['Üniversite Adı'] = "Izmir Ekonomi Universitesi"

# Son tabloyu görüntüle
print(df.head())

df.to_excel("Izmir Ekonomi Universitesi_17.07.2025.xlsx", index=False)
